...
export const metadata: Metadata = {
  title: "Next.js SignIn Page | VANT X ASOTECH - Next.js Dashboard Template",
  description: "This is Next.js Signin Page VANT X ASOTECH Dashboard Template",
};
...
const SignIn: React.FC = () => {
  return (
    <div>
      ...
      <div className=" min-h-screen flex items-center justify-center bg-white my-auto dark:border-strokedark dark:bg-boxdark">
